...
export class ThongTinKhaiQuatComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.thongTinKhaiQuatService
                ...
                .subscribe(
                    (res: HttpResponse<IThongTinKhaiQuat[]>) => this.paginateThongTinKhaiQuats(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/thong-tin-khai-quat'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    private paginateThongTinKhaiQuats(data: IThongTinKhaiQuat[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.thongTinKhaiQuats = data;
    }
