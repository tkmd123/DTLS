...
export class ThongTinMoComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.thongTinMoService
                ...
                .subscribe(
                    (res: HttpResponse<IThongTinMo[]>) => this.paginateThongTinMos(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/thong-tin-mo'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    private paginateThongTinMos(data: IThongTinMo[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.thongTinMos = data;
    }
