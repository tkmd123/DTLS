...
export class TinhThanhComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.tinhThanhService
                ...
                .subscribe(
                    (res: HttpResponse<ITinhThanh[]>) => this.paginateTinhThanhs(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/tinh-thanh'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    private paginateTinhThanhs(data: ITinhThanh[], headers: HttpHeaders) {
