...
import vn.homtech.dtls.repository.ThongTinKhaiQuatRepository;
import vn.homtech.dtls.repository.search.ThongTinKhaiQuatSearchRepository;
...
public class ThongTinKhaiQuatResource {
    ...
    @Timed
    public List<ThongTinKhaiQuat> getAllThongTinKhaiQuats() {
        log.debug("REST request to get all ThongTinKhaiQuats");
        return thongTinKhaiQuatRepository.findAll();
    }
    ...
    @Timed
    public List<ThongTinKhaiQuat> searchThongTinKhaiQuats(@RequestParam String query) {
        log.debug("REST request to search ThongTinKhaiQuats for query {}", query);
        return StreamSupport
            .stream(thongTinKhaiQuatSearchRepository.search(queryStringQuery(query)).spliterator(), false)
