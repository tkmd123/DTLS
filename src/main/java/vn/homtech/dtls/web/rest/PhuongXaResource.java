...
public class PhuongXaResource {
    ...
    @Timed
    public List<PhuongXa> getAllPhuongXas() {
        log.debug("REST request to get all PhuongXas");
    ...
    @Timed
    public List<PhuongXa> searchPhuongXas(@RequestParam String query) {
        log.debug("REST request to search PhuongXas for query {}", query);
        return StreamSupport
            .stream(phuongXaSearchRepository.search(queryStringQuery(query)).spliterator(), false)
