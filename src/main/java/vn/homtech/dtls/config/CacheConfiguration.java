...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(vn.homtech.dtls.domain.HoSoGiamDinh.class.getName(), jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.HoSoGiamDinh.class.getName() + ".hoSoGiamDinhs", jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.HoSoGiamDinh.class.getName() + ".giamDinhThanNhans", jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.HoSoGiamDinh.class.getName() + ".giamDinhLietSis", jcacheConfiguration);
            ...
            cm.createCache(vn.homtech.dtls.domain.MauXetNghiem.class.getName() + ".mauPCRS", jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.MauXetNghiem.class.getName() + ".mauTachChiets", jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.MauXetNghiem.class.getName() + ".mauDiemDotBiens", jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.MauXetNghiem.class.getName() + ".mauPhanTiches", jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.MauXetNghiem.class.getName() + ".mauTinhSaches", jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.HoaChat.class.getName(), jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.HoaChat.class.getName() + ".hoaChatTinhSaches", jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.HoaChat.class.getName() + ".hoaChatPhanUngs", jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.HoaChat.class.getName() + ".hoaChatTachChiets", jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.HoaChatMacDinh.class.getName(), jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.TachChiet.class.getName(), jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.TachChiet.class.getName() + ".tachChietMaus", jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.TachChiet.class.getName() + ".tachChietHoaChats", jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.HoaChatTachChiet.class.getName(), jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.MauTachChiet.class.getName(), jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.MayPCR.class.getName(), jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.MayPCR.class.getName() + ".mayTinhSaches", jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.MayPCR.class.getName() + ".mayPCRS", jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.PCRMoi.class.getName(), jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.PCRMoi.class.getName() + ".moiPCRS", jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.PCR.class.getName(), jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.PCR.class.getName() + ".pcrMaus", jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.PCR.class.getName() + ".pcrPhanUngs", jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.PCRPhanUngChuan.class.getName(), jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.PCRPhanUng.class.getName(), jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.PCRMau.class.getName(), jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.PCRKetQua.class.getName(), jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.PCRKetQua.class.getName() + ".pcrKetQuas", jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.TinhSach.class.getName(), jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.TinhSach.class.getName() + ".tinhSaches", jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.TinhSachPhanUng.class.getName(), jcacheConfiguration);
            ...
            cm.createCache(vn.homtech.dtls.domain.MappingDotBien.class.getName(), jcacheConfiguration);
            ...
            cm.createCache(vn.homtech.dtls.domain.TrungTam.class.getName(), jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.TrungTam.class.getName() + ".trungtams", jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.PhongBan.class.getName(), jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.PhongBan.class.getName() + ".phongbans", jcacheConfiguration);
            ...
            cm.createCache(vn.homtech.dtls.domain.NhanVien.class.getName(), jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.NhanVien.class.getName() + ".nhanVienTinhSaches", jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.NhanVien.class.getName() + ".nhanVienPCRS", jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.NhanVien.class.getName() + ".nhanVienNghienMaus", jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.NhanVien.class.getName() + ".nhanVienTachADNS", jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.NhanVien.class.getName() + ".nhanVienHSGDS", jcacheConfiguration);
            cm.createCache(vn.homtech.dtls.domain.NhanVien.class.getName() + ".nhanVienNhanMaus", jcacheConfiguration);
