...
public class HoSoThanNhan implements Serializable {
    ...
    @OneToMany(mappedBy = "hoSoThanNhan")
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
