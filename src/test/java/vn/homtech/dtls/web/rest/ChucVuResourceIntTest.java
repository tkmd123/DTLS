...
import vn.homtech.dtls.repository.ChucVuRepository;
import vn.homtech.dtls.repository.search.ChucVuSearchRepository;
...
public class ChucVuResourceIntTest {
     ...
     *
     * @see vn.homtech.dtls.repository.search.ChucVuSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createChucVu() throws Exception {
        ...
        assertThat(testChucVu.getUdf1()).isEqualTo(DEFAULT_UDF_1);
        assertThat(testChucVu.getUdf2()).isEqualTo(DEFAULT_UDF_2);
        assertThat(testChucVu.getUdf3()).isEqualTo(DEFAULT_UDF_3);
    ...
    public void updateChucVu() throws Exception {
        ...
        assertThat(testChucVu.getUdf1()).isEqualTo(UPDATED_UDF_1);
        assertThat(testChucVu.getUdf2()).isEqualTo(UPDATED_UDF_2);
        assertThat(testChucVu.getUdf3()).isEqualTo(UPDATED_UDF_3);
