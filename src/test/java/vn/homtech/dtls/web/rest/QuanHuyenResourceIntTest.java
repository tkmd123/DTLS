...
public class QuanHuyenResourceIntTest {
     ...
     *
     * @see vn.homtech.dtls.repository.search.QuanHuyenSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createQuanHuyen() throws Exception {
        ...
        assertThat(testQuanHuyen.isIsDeleted()).isEqualTo(DEFAULT_IS_DELETED);
        assertThat(testQuanHuyen.getUdf1()).isEqualTo(DEFAULT_UDF_1);
        assertThat(testQuanHuyen.getUdf2()).isEqualTo(DEFAULT_UDF_2);
        assertThat(testQuanHuyen.getUdf3()).isEqualTo(DEFAULT_UDF_3);
    ...
    public void updateQuanHuyen() throws Exception {
        ...
        assertThat(testQuanHuyen.isIsDeleted()).isEqualTo(UPDATED_IS_DELETED);
        assertThat(testQuanHuyen.getUdf1()).isEqualTo(UPDATED_UDF_1);
        assertThat(testQuanHuyen.getUdf2()).isEqualTo(UPDATED_UDF_2);
        assertThat(testQuanHuyen.getUdf3()).isEqualTo(UPDATED_UDF_3);
