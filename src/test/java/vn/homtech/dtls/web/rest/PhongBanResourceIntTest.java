...
import vn.homtech.dtls.repository.PhongBanRepository;
import vn.homtech.dtls.repository.search.PhongBanSearchRepository;
...
public class PhongBanResourceIntTest {
     ...
     *
     * @see vn.homtech.dtls.repository.search.PhongBanSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createPhongBan() throws Exception {
        ...
        assertThat(testPhongBan.getUdf1()).isEqualTo(DEFAULT_UDF_1);
        assertThat(testPhongBan.getUdf2()).isEqualTo(DEFAULT_UDF_2);
        assertThat(testPhongBan.getUdf3()).isEqualTo(DEFAULT_UDF_3);
    ...
    public void updatePhongBan() throws Exception {
        ...
        assertThat(testPhongBan.getUdf1()).isEqualTo(UPDATED_UDF_1);
        assertThat(testPhongBan.getUdf2()).isEqualTo(UPDATED_UDF_2);
        assertThat(testPhongBan.getUdf3()).isEqualTo(UPDATED_UDF_3);
