...
import vn.homtech.dtls.repository.ThanNhanLietSiRepository;
import vn.homtech.dtls.repository.search.ThanNhanLietSiSearchRepository;
...
public class ThanNhanLietSiResourceIntTest {
     ...
     *
     * @see vn.homtech.dtls.repository.search.ThanNhanLietSiSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createThanNhanLietSi() throws Exception {
        ...
        assertThat(testThanNhanLietSi.getUdf1()).isEqualTo(DEFAULT_UDF_1);
        assertThat(testThanNhanLietSi.getUdf2()).isEqualTo(DEFAULT_UDF_2);
        assertThat(testThanNhanLietSi.getUdf3()).isEqualTo(DEFAULT_UDF_3);
    ...
    public void updateThanNhanLietSi() throws Exception {
        ...
        assertThat(testThanNhanLietSi.getUdf1()).isEqualTo(UPDATED_UDF_1);
        assertThat(testThanNhanLietSi.getUdf2()).isEqualTo(UPDATED_UDF_2);
        assertThat(testThanNhanLietSi.getUdf3()).isEqualTo(UPDATED_UDF_3);
