...
public class TinhThanhResourceIntTest {
    ...
    public void createTinhThanh() throws Exception {
        ...
        assertThat(testTinhThanh.isIsDeleted()).isEqualTo(DEFAULT_IS_DELETED);
        assertThat(testTinhThanh.getUdf1()).isEqualTo(DEFAULT_UDF_1);
        assertThat(testTinhThanh.getUdf2()).isEqualTo(DEFAULT_UDF_2);
        assertThat(testTinhThanh.getUdf3()).isEqualTo(DEFAULT_UDF_3);
    ...
    public void updateTinhThanh() throws Exception {
        ...
        assertThat(testTinhThanh.isIsDeleted()).isEqualTo(UPDATED_IS_DELETED);
        assertThat(testTinhThanh.getUdf1()).isEqualTo(UPDATED_UDF_1);
        assertThat(testTinhThanh.getUdf2()).isEqualTo(UPDATED_UDF_2);
        assertThat(testTinhThanh.getUdf3()).isEqualTo(UPDATED_UDF_3);
