...
import vn.homtech.dtls.repository.HoSoLietSiRepository;
import vn.homtech.dtls.repository.search.HoSoLietSiSearchRepository;
...
public class HoSoLietSiResourceIntTest {
     ...
     *
     * @see vn.homtech.dtls.repository.search.HoSoLietSiSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createHoSoLietSi() throws Exception {
        ...
        assertThat(testHoSoLietSi.getuDF1()).isEqualTo(DEFAULT_U_DF_1);
        assertThat(testHoSoLietSi.getuDF2()).isEqualTo(DEFAULT_U_DF_2);
        assertThat(testHoSoLietSi.getuDF3()).isEqualTo(DEFAULT_U_DF_3);
    ...
    public void updateHoSoLietSi() throws Exception {
        ...
        assertThat(testHoSoLietSi.getuDF1()).isEqualTo(UPDATED_U_DF_1);
        assertThat(testHoSoLietSi.getuDF2()).isEqualTo(UPDATED_U_DF_2);
        assertThat(testHoSoLietSi.getuDF3()).isEqualTo(UPDATED_U_DF_3);
