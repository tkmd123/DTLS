...
import vn.homtech.dtls.repository.HoSoThanNhanRepository;
import vn.homtech.dtls.repository.search.HoSoThanNhanSearchRepository;
...
public class HoSoThanNhanResourceIntTest {
    ...
    private static final String DEFAULT_U_DF_1 = "AAAAAAAAAA";
    private static final String UPDATED_U_DF_1 = "BBBBBBBBBB";

    private static final String DEFAULT_U_DF_2 = "AAAAAAAAAA";
    private static final String UPDATED_U_DF_2 = "BBBBBBBBBB";

    private static final String DEFAULT_U_DF_3 = "AAAAAAAAAA";
    private static final String UPDATED_U_DF_3 = "BBBBBBBBBB";
     ...
     *
     * @see vn.homtech.dtls.repository.search.HoSoThanNhanSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createHoSoThanNhan() throws Exception {
        ...
        assertThat(testHoSoThanNhan.getuDF1()).isEqualTo(DEFAULT_U_DF_1);
        assertThat(testHoSoThanNhan.getuDF2()).isEqualTo(DEFAULT_U_DF_2);
        assertThat(testHoSoThanNhan.getuDF3()).isEqualTo(DEFAULT_U_DF_3);
    ...
    public void getAllHoSoThanNhans() throws Exception {
        ...
        restHoSoThanNhanMockMvc.perform(get("/api/ho-so-than-nhans?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].uDF1").value(hasItem(DEFAULT_U_DF_1.toString())))
            .andExpect(jsonPath("$.[*].uDF2").value(hasItem(DEFAULT_U_DF_2.toString())))
            .andExpect(jsonPath("$.[*].uDF3").value(hasItem(DEFAULT_U_DF_3.toString())));
    }
    ...
    public void getHoSoThanNhan() throws Exception {
        ...
        restHoSoThanNhanMockMvc.perform(get("/api/ho-so-than-nhans/{id}", hoSoThanNhan.getId()))
            ...
            .andExpect(jsonPath("$.uDF1").value(DEFAULT_U_DF_1.toString()))
            .andExpect(jsonPath("$.uDF2").value(DEFAULT_U_DF_2.toString()))
            .andExpect(jsonPath("$.uDF3").value(DEFAULT_U_DF_3.toString()));
    }
    ...
    public void updateHoSoThanNhan() throws Exception {
        ...
        assertThat(testHoSoThanNhan.getuDF1()).isEqualTo(UPDATED_U_DF_1);
        assertThat(testHoSoThanNhan.getuDF2()).isEqualTo(UPDATED_U_DF_2);
        assertThat(testHoSoThanNhan.getuDF3()).isEqualTo(UPDATED_U_DF_3);
    ...
    public void searchHoSoThanNhan() throws Exception {
        ...
        restHoSoThanNhanMockMvc.perform(get("/api/_search/ho-so-than-nhans?query=id:" + hoSoThanNhan.getId()))
            ...
            .andExpect(jsonPath("$.[*].isDeleted").value(hasItem(DEFAULT_IS_DELETED.booleanValue())))
            .andExpect(jsonPath("$.[*].uDF1").value(hasItem(DEFAULT_U_DF_1)))
            .andExpect(jsonPath("$.[*].uDF2").value(hasItem(DEFAULT_U_DF_2)))
            .andExpect(jsonPath("$.[*].uDF3").value(hasItem(DEFAULT_U_DF_3)));
    }
