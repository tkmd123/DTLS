...
public class ThongTinADNResourceIntTest {
     ...
     *
     * @see vn.homtech.dtls.repository.search.ThongTinADNSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void searchThongTinADN() throws Exception {
        // Initialize the database
        thongTinADNRepository.saveAndFlush(thongTinADN);
        when(mockThongTinADNSearchRepository.search(queryStringQuery("id:" + thongTinADN.getId())))
            .thenReturn(Collections.singletonList(thongTinADN));
