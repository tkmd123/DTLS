...
public class DiemDotBienResourceIntTest {
     ...
     *
     * @see vn.homtech.dtls.repository.search.DiemDotBienSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void searchDiemDotBien() throws Exception {
        // Initialize the database
        diemDotBienRepository.saveAndFlush(diemDotBien);
        when(mockDiemDotBienSearchRepository.search(queryStringQuery("id:" + diemDotBien.getId())))
            .thenReturn(Collections.singletonList(diemDotBien));
