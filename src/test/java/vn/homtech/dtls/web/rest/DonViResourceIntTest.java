...
import vn.homtech.dtls.repository.DonViRepository;
import vn.homtech.dtls.repository.search.DonViSearchRepository;
...
public class DonViResourceIntTest {
     ...
     *
     * @see vn.homtech.dtls.repository.search.DonViSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createDonVi() throws Exception {
        ...
        assertThat(testDonVi.getUdf1()).isEqualTo(DEFAULT_UDF_1);
        assertThat(testDonVi.getUdf2()).isEqualTo(DEFAULT_UDF_2);
        assertThat(testDonVi.getUdf3()).isEqualTo(DEFAULT_UDF_3);
    ...
    public void updateDonVi() throws Exception {
        ...
        assertThat(testDonVi.getUdf1()).isEqualTo(UPDATED_UDF_1);
        assertThat(testDonVi.getUdf2()).isEqualTo(UPDATED_UDF_2);
        assertThat(testDonVi.getUdf3()).isEqualTo(UPDATED_UDF_3);
