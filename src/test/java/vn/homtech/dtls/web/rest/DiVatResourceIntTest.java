...
public class DiVatResourceIntTest {
    ...
    public void createDiVat() throws Exception {
        ...
        assertThat(testDiVat.getUdf1()).isEqualTo(DEFAULT_UDF_1);
        assertThat(testDiVat.getUdf2()).isEqualTo(DEFAULT_UDF_2);
        assertThat(testDiVat.getUdf3()).isEqualTo(DEFAULT_UDF_3);
    ...
    public void updateDiVat() throws Exception {
        ...
        assertThat(testDiVat.getUdf1()).isEqualTo(UPDATED_UDF_1);
        assertThat(testDiVat.getUdf2()).isEqualTo(UPDATED_UDF_2);
        assertThat(testDiVat.getUdf3()).isEqualTo(UPDATED_UDF_3);
