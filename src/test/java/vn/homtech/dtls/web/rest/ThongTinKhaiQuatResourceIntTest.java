...
public class ThongTinKhaiQuatResourceIntTest {
     ...
     *
     * @see vn.homtech.dtls.repository.search.ThongTinKhaiQuatSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void searchThongTinKhaiQuat() throws Exception {
        // Initialize the database
        thongTinKhaiQuatRepository.saveAndFlush(thongTinKhaiQuat);
        when(mockThongTinKhaiQuatSearchRepository.search(queryStringQuery("id:" + thongTinKhaiQuat.getId())))
            .thenReturn(Collections.singletonList(thongTinKhaiQuat));
