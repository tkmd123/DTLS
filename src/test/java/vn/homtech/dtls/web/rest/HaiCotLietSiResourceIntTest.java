...
import vn.homtech.dtls.repository.HaiCotLietSiRepository;
import vn.homtech.dtls.repository.search.HaiCotLietSiSearchRepository;
...
public class HaiCotLietSiResourceIntTest {
     ...
     *
     * @see vn.homtech.dtls.repository.search.HaiCotLietSiSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createHaiCotLietSi() throws Exception {
        ...
        assertThat(testHaiCotLietSi.isCoHaiCot()).isEqualTo(DEFAULT_CO_HAI_COT);
    ...
    public void updateHaiCotLietSi() throws Exception {
        ...
        assertThat(testHaiCotLietSi.isCoHaiCot()).isEqualTo(UPDATED_CO_HAI_COT);
